...
import com.mail.vo.OrderItemVo;
import com.mail.vo.OrderProductVo;
import com.mail.vo.OrderVo;
import com.mail.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuffer().append("zjl线上支付，订单号：").append(outTradeNo).toString();
        ...
        String body = new StringBuffer().append("订单").append(outTradeNo).append("够买商品共").append(totalAmount).append("元").toString();
...
//        goodsDetailList.add(goods1);
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMsg("订单不存在，回调忽略");
        }
